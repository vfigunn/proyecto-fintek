...
const TeamMember = ({ name, role, bio, image, linkedin, github }: TeamMemberProps) => {
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
      <div className="aspect-square overflow-hidden">
        <img 
          src={image} 
          alt={name} 
          className="w-full h-full object-cover object-[65%_35%] transform hover:scale-105 transition-transform duration-300"
        />
      </div>
      <CardHeader className="pb-2">
        <CardTitle className="text-xl text-indigo-800">{name}</CardTitle>
      ...
      <CardFooter className="flex justify-center pt-0">
        <div className="flex space-x-3">
          <a href={linkedin} target="_blank" className="text-gray-500 hover:text-fintek-blue">
          ...
          <a href={github} target="_blank" className="text-gray-500 hover:text-fintek-blue">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
...
const TeamSection = () => {
  ...
  return (
    <section id="equipo" className="bg-gray-50 section-padding">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Nuestro Equipo</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Conozca a los estudiantes detrás del desarrollo de FINTEK, un proyecto académico del 
